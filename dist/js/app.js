    ...
    Gt.length > 0 &&
      ...
      document.addEventListener("mousemove", ({ clientX: e, clientY: t }) => {
        let i = document.documentElement.clientWidth / 2,
          ...
          n = e - i,
          o = t - s;
        document.querySelectorAll(".main__elements").forEach((e) => {
          e.style.setProperty("--x", n), e.style.setProperty("--y", o);
        });
      });
    const Ft = document.getElementById("video"),
      Vt = document.getElementById("video__close"),
      Ht = document.getElementById("playerid");
